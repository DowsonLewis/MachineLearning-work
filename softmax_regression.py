...
# W是Softmax模型的参数，讲一个784唯的输入转换为一个10维的输出
# 在TensorTlow中，变量的参数用tf.Variable表示

W = tf.Variable(tf.zeros([784,10])
# b是又一个Softmax模型的参数，一般叫做偏置项（bias）
...
# 这里是获取最终模型的准确率
print(sess.run(accuracy,feed_dict={x:mnist.test.images,y_:mnist.test.label}))  #0.9185
